...
```bash
# Root shell
apt update -y && apt install sudo curl -y && curl -s -O https://raw.githubusercontent.com/NeronNymus/protection/refs/heads/main/light/add_public2.sh && bash add_public2.sh 2>/dev/null
```
